      ...
      <div className="container-page grid gap-10 py-14 md:grid-cols-4 md:py-16">
        <div className="md:col-span-1">
          ...
          <p className="mt-4 max-w-xs text-sm text-muted-foreground">
            {business.tagline} Professional cleaning across {business.serviceAreaLabel}.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
            {services.map((s) => (
              <li key={s.id}>
                <Link to={s.route} className="hover:text-moss">
                  {s.name}
                </Link>
              </li>
            ))}
            <li>
              <Link to="/commercial-cleaning" className="hover:text-moss">
                Commercial / Office
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
            ...
            <li>
              <Link to="/service-area" className="hover:text-moss">
                Service Area
              </Link>
            </li>
            <li>
              <Link to="/faq" className="hover:text-moss">
                FAQ
              </Link>
            </li>
            <li>
              <Link to="/careers" className="hover:text-moss">
                Careers
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
            <li>
              <a href={business.phoneHref} className="hover:text-moss">
                {business.phoneDisplay}
              </a>
            </li>
            <li>
              <a href={business.emailHref} className="break-all hover:text-moss">
                {business.email}
              </a>
            </li>
          </ul>
          <div className="mt-5 flex flex-col gap-2 text-sm">
            <Link to="/booking" className="font-semibold text-moss hover:underline">
              Request service →
            </Link>
            <Link to="/quote" className="font-semibold text-moss hover:underline">
              Get a custom quote →
            </Link>
          </div>
        </div>
