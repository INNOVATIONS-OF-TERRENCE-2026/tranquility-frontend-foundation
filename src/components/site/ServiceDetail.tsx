    ...
    <>
      ...
      <section className="section">
        <div className="container-page grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          <div>
            <SectionHeading
              title={text({ en: "What this service covers", es: "Qué incluye este servicio" })}
              intro={text(descriptions[service.id])}
            />
            ...
            {localizedNotes && (
              <p className="mt-8 border-l-2 border-moss bg-sand/60 px-5 py-4 text-sm leading-relaxed text-muted-foreground">
                {localizedNotes}
              </p>
            )}
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-2xl">
                    {text({
                      en: "Need a nonstandard scope?",
                      es: "¿Necesitas un alcance fuera de lo estándar?",
                    })}
                  </h3>
                  ...
                  <Link
                    to="/quote"
                    className="mt-4 inline-flex min-h-11 items-center text-sm font-semibold text-moss hover:underline"
                  >
                    {text({
          ...
          <aside className="rounded-xl border border-border bg-card p-6 shadow-soft lg:sticky lg:top-32">
            ...
            <p className="text-xs uppercase tracking-wide text-muted-foreground">
              {text({
                en: "One-time, standard average 1 bed / 1 bath home",
                es: "Una visita, vivienda estándar promedio de 1 dormitorio / 1 baño",
              })}
            </p>
            ...
            <Button asChild className="mt-6 w-full">
              <Link to="/booking" search={{ service: service.id }}>
                {text({ en: "Build my estimate", es: "Calcular mi estimado" })}
              </Link>
            </Button>
