...
export function CTABand({
  ...
  return (
    <section className="brand-dark relative overflow-hidden border-y border-gold/20 bg-background text-foreground">
      <div
        className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(226,194,122,0.16),transparent_24%),linear-gradient(110deg,transparent_0%,rgba(255,255,255,0.025)_55%,transparent_100%)]"
        aria-hidden="true"
      />
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap lg:justify-end">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-gold/35 text-foreground hover:bg-gold/10 hover:text-gold-soft"
            >
              <Link to="/quote">
            ...
            <Button
              ...
              size="lg"
              variant="ghost"
              className="text-foreground hover:bg-gold/10 hover:text-gold-soft"
            >
