  ...
  return (
    <>
      <PageHero
        ...
        title={text({
          en: "Commercial cleaning, quoted properly",
          es: "Limpieza comercial con una cotización adecuada",
        })}
        intro={text({
      ...
      >
        <div className="flex flex-col gap-3 sm:flex-row">
          <Button asChild size="lg">
            <Link to="/quote">
              {text({ en: "Request a consultation", es: "Solicitar una consulta" })}
            </Link>
          </Button>
        ...
        <div className="container-page grid gap-12 lg:grid-cols-2 lg:items-start">
          <div>
            <SectionHeading
              ...
              intro={text({
                en: "A focused conversation gives us what we need to build a realistic scope and schedule.",
                es: "Una conversación enfocada nos brinda la información necesaria para definir un alcance y un horario realistas.",
              })}
            />
          ...
          <div className="rounded-2xl border border-border bg-sand p-7 shadow-soft md:p-8">
            ...
            <h2 className="mt-3 text-2xl">
              {text({
                en: "Why there is no instant commercial price",
                es: "Por qué no ofrecemos un precio comercial instantáneo",
              })}
            </h2>
            ...
            <Button asChild className="mt-6">
              <Link to="/quote">
                {text({ en: "Start a commercial quote", es: "Iniciar cotización comercial" })}
              </Link>
            </Button>
          </div>
        </div>
