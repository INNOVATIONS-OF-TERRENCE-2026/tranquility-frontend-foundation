  ...
  es: [
    {
      ...
      body: "Conoces el alcance, el precio y lo que sigue antes de comenzar. Cualquier cambio se confirma contigo primero.",
    },
    {
      title: "Respeto por tu espacio",
      body: "Tu hogar no es un lugar de trabajo cualquiera. Trabajamos con cuidado alrededor de tus pertenencias, tus superficies y tu forma de vivir.",
    },
    {
      title: "Consistencia",
      body: "Mantener el mismo estándar en cada visita ayuda a que el hogar conserve esa sensación de calma entre limpiezas.",
    },
    {
      title: "Atención cuidadosa",
      body: "Las mascotas, distribuciones particulares, materiales delicados y condiciones especiales se consideran con anticipación en lugar de improvisarse el día del servicio.",
    },
  ],
};
  ...
  return (
    <>
      <PageHero
        ...
        title={text({
          en: "Cleaning that makes a home feel lighter",
          es: "Limpieza que hace que tu hogar se sienta más ligero",
        })}
        intro={text({
      ...
      <section className="section">
        <div className="container-page grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-border bg-stone-soft p-6 shadow-soft md:p-8">
            <div className="relative">
              <div className="mx-auto flex size-52 items-center justify-center p-3">
                <img
              ...
              <p className="mt-6 text-center font-display text-3xl text-ink">
                Tranquility Level Cleaning
              </p>
              <p className="mt-2 text-center text-[0.62rem] font-bold uppercase tracking-[0.2em] text-moss">
                {text({
              ...
              <div className="mt-7 grid grid-cols-3 gap-3 border-t border-border pt-5 text-center">
                <div>
                  ...
                  <p className="mt-2 text-[0.58rem] uppercase tracking-[0.12em] text-muted-foreground">
      ...
      <section className="section border-y border-border bg-[linear-gradient(180deg,var(--background),var(--sand))]">
        <div className="container-page">
          <SectionHeading
            ...
            title={text({
              en: "The people behind the experience",
              es: "Las personas detrás de la experiencia",
            })}
            intro={text({
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-[1.12fr_0.88fr]">
            <article className="relative overflow-hidden rounded-[2rem] border border-border bg-card p-7 shadow-soft md:p-9">
              <div
                className="absolute right-0 top-0 h-40 w-40 rounded-full bg-moss/8 blur-3xl"
                aria-hidden="true"
              />
              <div className="relative">
            ...
            <article className="relative overflow-hidden rounded-[2rem] border border-border bg-stone-soft p-7 shadow-soft md:p-9">
              <div className="relative">
                ...
                <h2 className="mt-4 text-3xl text-ink md:text-4xl">{technologyLeader.name}</h2>
                <p className="mt-3 text-sm font-semibold text-foreground">
                  {text(technologyLeader.role)}
                </p>
                <p className="mt-1 text-sm text-muted-foreground">{technologyLeader.company}</p>
                <p className="mt-3 text-sm font-medium text-moss">
                  {text(technologyLeader.designation)}
                </p>
                <p className="mt-6 text-sm leading-7 text-muted-foreground">
                  {text(technologyLeader.bio)}
                </p>
                ...
                <div className="mt-7 flex flex-wrap gap-2">
                  {technologyLeader.disciplines.slice(0, 6).map((discipline) => (
                    <span
                      key={discipline.en}
                      className="rounded-full border border-border bg-card px-3 py-1.5 text-[0.68rem] font-medium text-muted-foreground"
                    >
                      {text(discipline)}
                    </span>
                  ))}
      ...
      <section className="section bg-sand">
        <div className="container-page">
          <SectionHeading
            eyebrow={text({ en: "What we hold to", es: "Nuestros principios" })}
            title={text({ en: "How we work", es: "Cómo trabajamos" })}
          />
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            {values[language].map((value, index) => (
              ...
              >
                <span className="flex size-10 items-center justify-center rounded-2xl bg-accent text-moss">
                  <Sparkles className="size-4" aria-hidden="true" />
                </span>
                <p className="mt-4 text-xs font-bold uppercase tracking-[0.16em] text-moss">
                  0{index + 1}
                </p>
